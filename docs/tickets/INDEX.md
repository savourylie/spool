...
> **Last updated**: 2026-04-24 (TICKET-080 done) <!-- updated by /update-ticket -->
...
| 079 | [AI-Tone Marker Taxonomy](./079-ai-tone-marker-taxonomy.md)                     | `done`    | #078 ✅        | Unblocked — 10+5+5 markers, span-level highlighting in draft preview, 6 remediations |
| 080 | [Concept Library Infra](./080-concept-library-infra.md)                         | `done`    | #065 ✅, #067 ✅ | `concept_ledger` table, extraction classifier, reuse-risk aggregate |
| 081 | [Concept Library UI + Composer Check](./081-concept-library-ui-and-composer-check.md) | `pending` | #080 ✅   | Unblocked — `/dashboard/understand/concepts` table + Composer pre-draft analogy advisory |

### v3 Phase 6 — Integration Pass (082)

| #   | Ticket                                                                          | Status    | Depends On     | Notes |
| --- | ------------------------------------------------------------------------------- | --------- | -------------- | ----- |
| 082 | [v3 QA & Integration Pass](./082-v3-qa-integration.md)                          | `blocked` | #065-#081 (#078 ✅, #080 ✅) | Cross-feature flows, cache hit rate, confidence-badge coverage, regressions |
...
Phase 5 (diagnostic polish):
  065 ─┬─► 077 Scanner 4-axis Backend ✅ DONE ──► 078 4-axis UI ✅ DONE ──► 079 AI-Tone Markers ✅ DONE
  067 ✅ DONE ─┤
       └─► 080 Concept Library Infra ✅ DONE ──► 081 Concept Library UI 📋 PENDING
