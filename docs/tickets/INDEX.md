...
> **Last updated**: 2026-04-23 (TICKET-066 done, TICKET-073 unblocked) <!-- updated by /update-ticket -->
...
| 067 | [Prompt Loader Refactor + Caching](./067-prompt-loader-and-caching.md)         | `pending` | #065 ✅      | Unblocked — Scanner + Composer load from `src/lib/prompts/`; Anthropic cache_control breakpoints |
...
```
Phase 1 (foundation):
  065 Knowledge Prompts ✅ DONE ──┬──► 067 Prompt Loader ──┐
...
Phase 3 (freshness):
  065 ✅ DONE ─┬─► 071 Freshness Gate Infra ──► 072 Today Hub Filter
  067 ─────────┘
