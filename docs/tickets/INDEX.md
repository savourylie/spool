...
> **Last updated**: 2026-04-24 (TICKET-077 done, unblocks TICKET-078) <!-- updated by /update-ticket -->
...
| 069 | [Brand Voice UI Panel](./069-brand-voice-ui-panel.md)                           | `done`    | #066 ✅, #068 ✅    | `/dashboard/understand/voice` accordion with excerpts + refresh button |
| 070 | [Brand Voice Composer + Scanner Wiring](./070-brand-voice-composer-scanner-wiring.md) | `done`    | #068 ✅    | Primary driver in Composer, observer-only in Scanner; `voice-drift` category + discipline doc |
...
| #   | Ticket                                                                          | Status    | Depends On   | Notes |
| --- | ------------------------------------------------------------------------------- | --------- | ------------ | ----- |
| 071 | [Freshness Gate Infra](./071-freshness-gate-infra.md)                           | `done`    | #065 ✅, #067 ✅ | `freshness_checks` table, combined external + self-repetition check, Composer banner |
| 072 | [Today Hub Freshness Filter + Audit Surface](./072-today-hub-freshness-filter.md) | `pending` | #071 ✅    | Unblocked — Today Hub "What to post" filter + freshness log health card |

### v3 Phase 4 — Prediction → Actual Loop (073-076)

| #   | Ticket                                                                          | Status    | Depends On         | Notes |
| --- | ------------------------------------------------------------------------------- | --------- | ------------------ | ----- |
| 073 | [Post Predictions Persistence](./073-post-predictions-persistence.md)           | `done`    | #066 ✅               | `post_predictions` table, snapshot on compose, fuzzy-match link-back in backfill |
| 074 | [Review Sweep + Narrative](./074-review-sweep-and-narrative.md)                 | `pending` | #067 ✅, #073 ✅    | Unblocked — #073 now done; `/api/reviews/sweep` scheduled endpoint, LLM narrative per post |
...
| #   | Ticket                                                                          | Status    | Depends On     | Notes |
| --- | ------------------------------------------------------------------------------- | --------- | -------------- | ----- |
| 077 | [Scanner Four-Axis Backend](./077-scanner-four-axis-backend.md)                 | `done`    | #065 ✅, #067 ✅ | 4-axis output shape, `analyze.md` prompt, neighbor-post citations, feature flag |
| 078 | [Scanner Four-Axis UI](./078-scanner-four-axis-ui.md)                           | `pending` | #077 ✅        | Unblocked — 4 collapsible cards, rule pills, "Get rewrite suggestions" CTA to Composer |
...
Phase 1 (foundation):
  ...
  066 Confidence Util + Badge ✅ DONE (standalone)                  │
                                                                     │
Phase 2 (brand voice):                                               │
  067 ✅ DONE ─► 068 Brand Voice Infra ✅ DONE ──┬──► 069 Brand Voice UI ✅ DONE
  066 ✅ DONE ──────────────────────────────────┘
  068 ✅ DONE ─────────────────────────────► 070 Composer + Scanner Wiring ✅ DONE

Phase 3 (freshness):
  065 ✅ DONE ─┬─► 071 Freshness Gate Infra ✅ DONE ──► 072 Today Hub Filter 📋 PENDING
  067 ✅ DONE ─┘

Phase 4 (review loop):
  066 ✅ DONE ─► 073 Predictions Persistence ✅ DONE ──────┬──► 074 Review Sweep 📋 PENDING ──┬──► 075 Reviews Page
  067 ✅ DONE ────────────────────────────────────────────┘                       ├──► 076 Latest Review Card
  072 ───────────────────────────────────────────────────────────────────────────┘

Phase 5 (diagnostic polish):
  065 ─┬─► 077 Scanner 4-axis Backend ✅ DONE ──► 078 4-axis UI 📋 PENDING ──► 079 AI-Tone Markers
  067 ✅ DONE ─┤
